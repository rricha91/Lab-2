...
public class NumericTypes {
	public static void main (String [] args) {
		...
		System.out.println("Please enter the second score: "); 				 // prompt user to input score2
		int score2 = input.nextInt();											 // read score2 
		
		double average = ((double) score1 + score2) / NUMBER; 				// Find arithmetic average

		String output = score1 + " and " + score2 + " have an average of " + average;	// line of output to print out
...
// Convert Fahrenheit temperatures to Celsius
		...
		System.out.println(output);
																				 ...
																				 */
		System.out.println("Please enter the tempreture you want in Degrees F: "); 
